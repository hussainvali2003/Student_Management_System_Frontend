...
function ManageFaculty() {
  ...
  const fetchFaculty = async () => {
    try {
      const response = await axios.get("https://student-management-system-backend-1.onrender.com/api/faculty");
  ...
  const handleCreate = async () => {
    try {
      await axios.post("https://student-management-system-backend-1.onrender.com/api/faculty", newFaculty);
      fetchFaculty();
