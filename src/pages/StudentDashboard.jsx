  ...
  const handleFileChange = async (e) => {
    ...
    try {
      const response = await axios.post(
        `https://student-management-system-backend-1.onrender.com/api/students/${student.id}/upload-pic`,
        formData,
        {
        ...
        <div className="sidebar-header">
          <div className="student-avatar-wrapper">
            {student.profilePicUrl ? (
              <img
                src={`https://student-management-system-backend-1.onrender.com/uploads/${student.profilePicUrl}`}
                alt="Profile"
