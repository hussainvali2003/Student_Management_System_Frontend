...
function Login() {
  ...
  const handleLogin = async (e) => {
    ...
    const loginUrl =
      role === 'STUDENT'
        ? 'https://student-management-system-backend-1.onrender.com/api/students/login'
        : role === 'FACULTY'
        ? 'https://student-management-system-backend-1.onrender.com/api/faculty/login'
        : 'https://student-management-system-backend-1.onrender.com/api/auth/login';
